...
The process of amplicon analysis consists of program executions with data conversion between the executions.  Programs are run on workstations, such as data entry, conversion and visualization; servers in network infrastructures, such as database queries and results publishing, and nodes of the cluster.  The
