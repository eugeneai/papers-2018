...
\author{\IEEEauthorblockN{Viacheslav Paramonov\IEEEauthorrefmark{1},
Alexey Shigarov\IEEEauthorrefmark{1},
Gennady Ruzhnikov\IEEEauthorrefmark{1},
Evgeny Cherkashin\IEEEauthorrefmark{1}
}
%
\IEEEauthorblockA{\IEEEauthorrefmark{1}Matrosov Institute for System Dynamics and Control Theory, Irkutsk, Russia\\ \{slv, shigarov, rugnikov, eugeneai\}@icc.ru}
\IEEEauthorblockA{\IEEEauthorrefmark{2}Institute of Mathematics, Economics and Informatics \\ Irkutsk State University, Irkutsk, Russia}
}
