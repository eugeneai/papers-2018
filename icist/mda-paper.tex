...
\author{%
%   Evgeny Cherkashin\inst{1,2,5,6},
...
model. \emph{IAENG International Journal of Computer Science}, vol.~45(1), 2018, 104-117.

\bibitem{}
\textbf{Hamid, B., Weber, D.} Engineering secure systems: Models, patterns
and empirical validation. \emph{Computers and Security},  vol~77, 2018, p.~315-348.
doi:10.1016/j.cose.2018.03.016

\bibitem{}
\textbf{Tragatschnig, S., Stevanetic, S., Zdun, U.} Supporting the
evolution of event-driven service-oriented architectures using change
patterns. \emph{Information and Software Technology.} vol.~100, 2018, p.!133-146.
