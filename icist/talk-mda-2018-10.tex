...
\begin{frame}
  ...
  \item usage of LOD sources in the transformations for obtaining additional semantic data,
...
\begin{frame}
  ...
  We describe transformation in Prolog (Logtalk), representing CIM, PIM and PSM as RDF graphs, allowing non-XMI sources to be used, organizing multi-stage modular transformations.
...
\begin{frame}[fragile]
  ...
  \item has a way of global element identification, \emph{i.e.} we can refer the same object from different software systems;
