...
%Programmatic SysML interpretation and code synthesis
...
%Related research
\bibitem{raslan} Waseem Raslan, Ahmed Sameh: Accelerating High-Level SysML and SystemC SoC Designs, https://www.design-reuse.com/articles/17562/high-level-sysml-systemc-soc-designs.html
...
\bibitem{tom16}Tom Hauswald. Automatic Code Synthesis of UML/SysML State Machines for airb orne Applications.  Bachelor Thesis. Hamburg Univeristy of Technology. Auguust 15. 2016. 80~p.
\end{thebibliography}
\end{document}
